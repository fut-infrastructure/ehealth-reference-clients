...
import dk.sundhed.ehealth.referenceclients.common.fhir.*;
...
public class EpisodeOfCareAPI {
     ...
     * {@link dk.sundhed.ehealth.referenceclients.clinician.mappers.EpisodeOfCareMapper#toCreateEpisodeTransaction}.
     */
