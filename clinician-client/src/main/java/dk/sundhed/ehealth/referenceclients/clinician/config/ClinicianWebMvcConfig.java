package dk.sundhed.ehealth.referenceclients.clinician.config;

import dk.sundhed.ehealth.referenceclients.clinician.config.spring.EHealthContextArgumentResolver;
import dk.sundhed.ehealth.referenceclients.clinician.config.spring.SelectedContextInterceptor;
