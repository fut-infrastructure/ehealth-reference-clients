...
public class TasksController {
    ...
    public TasksController(TaskAPI taskAPI, MeasurementAPI measurementAPI, IdFactory idFactory) {
    ...
    public String tasks(
        ...
        model.addAttribute("tasks", TaskView.from(tasks, idFactory, byObservation));
        return "tasks";
    }
